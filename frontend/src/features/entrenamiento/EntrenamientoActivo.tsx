...
import { BarraProgreso } from './activo/UIComponents';
  ...
  return (
    <>
      <div className="fixed inset-0 z-[9999] bg-slate-900 text-white flex flex-col items-center overflow-y-auto overflow-x-hidden">
        ...
        {/* CABECERA FIJA Y BARRA DE PROGRESO */}
        {state.step !== 'FINISHED' && (
          <div className="w-full max-w-3xl px-4 pt-4 pb-3 flex flex-col bg-slate-900/90 sticky top-0 z-30 backdrop-blur-md border-b border-slate-800">
            ...
            {/* Si estamos dentro de la rutina (ejecución o descanso), mostramos la barra */}
