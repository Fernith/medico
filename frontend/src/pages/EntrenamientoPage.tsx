    ...
    <div className="max-w-7xl mx-auto p-4 space-y-8 pb-24 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-4 border-b-2 border-indigo-200 pb-4">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">Gestiona tus ejercicios y diseña tus rutinas</p>
        </div>
      </div>

      {!isLoading ? (
        <div className="flex flex-col gap-10">
          {/* SECCIÓN PRINCIPAL: EJERCICIOS */}
          <div className="w-full">
            <EjerciciosTabla ejercicios={ejercicios} />
          </div>

          {/* SECCIÓN DE ADMINISTRACIÓN DE DATOS (2 Columnas en PC, 1 en móvil) */}
